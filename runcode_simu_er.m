%% T = 100 with 0 break, sparsity = 0.2
addpath(genpath(pwd))
clear
clc
rng(1,"twister");
...
er_exps(T, p, num_breaks, prob, num_exps, lamb1s, lamb2s, lamb3, epsilon, beta_, tau, Nsim);
...
filename = ['er-T', num2str(T), '-p', num2str(p), '-s', num2str(prob), '-m', num2str(num_breaks), '.mat'];
...
%% T = 100 with 0 break, sparsity = 0.7
addpath(genpath(pwd))
clear
clc
rng(2,"twister");
...
%% T = 150 with 1 break, sparsity = 0.2
addpath(genpath(pwd))
clear
clc
rng(3,"twister");
...
%% T = 150 with 1 break, sparsity = 0.7
addpath(genpath(pwd))
clear
clc
rng(4,"twister");
...
%% T = 150 with 4 breaks, sparsity = 0.2
addpath(genpath(pwd))
clear
clc
rng(5,"twister");
...
%% T = 150 with 4 breaks, sparsity = 0.7
addpath(genpath(pwd))
clear
clc
rng(6,"twister");
...
%% T = 150 with 6 breaks, sparsity = 0.2
addpath(genpath(pwd))
clear
clc
rng(7,"twister");
...
%% T = 150 with 6 breaks, sparsity = 0.7
addpath(genpath(pwd))
clear
clc
rng(8,"twister");
